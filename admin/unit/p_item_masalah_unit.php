...
<?php
    ...
    case "proses":
      ...
      if(count($results) == 1)
      {
	    ...
	    $qinput = " INSERT INTO t_hasil (tanggal, item_masalah, bidang_masalah, hasil_id, nilai_cf, kode_siswa)
                VALUES (
            '$inptanggal',
            '$inpgejala',
            '$inpbidang',
...
<?php
  ...
  case "inputact":
    ...
    $kelas = $_POST['kelas'];
      ...
      $qinput = " INSERT INTO t_siswa (kode_siswa, nama_siswa, jenis_kelamin, kelas)
              VALUES ('$id_siswa', '$nama_siswa', '$jenis_kelamin', '$kelas') ";
