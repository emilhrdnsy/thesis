			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="alert alert-block alert-success">
						...
						<i class=""></i> Sebuah sistem yang digunakan untuk mengidentifikasi masalah belajar siswa. Dibangun
						menggunakan bahasa pemrograman PHP dan mengimplementasikan Metode <i>Certainty Factor</i>
					</div>
				</div><!-- /.col -->
			</div><!-- /.row -->
