        ...
        <div class="col-xs-12">
          <form class="form-horizontal" name="tambah_subkat" id="tambah_subkat" method="post" action="?unit=dbp_unit&act=inputact" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select class="col-xs-10 col-sm-5" name="kode_bidang_masalah" id="kode_bidang_masalah" required>
                  <option value="" selected="selected">--Pilih Bidang Masalah--</option>
                  <?php
                    $qcombo = " SELECT * FROM t_bidang_masalah ";
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select class="col-xs-10 col-sm-5" name="kode_item_masalah" id="kode_item_masalah" required>
                  <option value="" selected="selected">--Pilih Item Masalah--</option>
                  <?php
                    $qcombo = " SELECT * FROM t_item_masalah ";
                    $rcombo = mysqli_query($mysqli,$qcombo);
                    while($dcombo = mysqli_fetch_assoc($rcombo)) {
                      echo "
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" type="text" name="mb" id="mb" placeholder="e.g 0.8" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" type="text" name="md" id="md" placeholder="e.g 0.2" />
              </div>
            </div>
...
?>
<script>
  var cek1 = document.getElementById('kode_bidang_masalah').value;
  var cek2 = document.getElementById('kode_item_masalah').value;
  var cek3 = document.getElementById('mb').value;
  var cek4 = document.getElementById('md').value;

  function confirm() {
    if(cek1 == ""){
      swal.fire({
        title: 'Field Bidang Masalah Kosong',
        type: 'info',
        showCancelButton: true,
        cancelButtonText: 'Ok',
        showConfirmButton: false,
...
<?php
  ...
  case "inputact":
    ...
    $qinput = " INSERT INTO t_identifikasi ( kode_bidang_masalah, kode_item_masalah, mb, md, cf_bidang_masalah)
                VALUES ('$kode_bidang_masalah', '$kode_item_masalah', '$mb', '$md', '$cf_bidang_masalah')";
        ...
        <div class="col-xs-12">
          <form class="form-horizontal" name="tambah_subkat" id="tambah_subkat" method="post"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" type="text" name="kode_identifikasi" id="kode_identifikasi"
                  required="required" value="<?php echo $dupdate['kode_identifikasi'] ?>" readonly="" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="kode_bidang_masalah">Bidang Masalah</label>
...
<?php
  ...
  case "updateact":
    ...
    $md = $_POST['md'];
    $cf_bidang_masalah = $mb-$md;
    $qinput = " UPDATE t_identifikasi SET
  ...
  case "delete":
    $kode_identifikasi = $_GET['kode_identifikasi'];
    $qdelete = " DELETE  FROM t_identifikasi
                WHERE kode_identifikasi = '$kode_identifikasi'
              ";
