				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="alert alert-block alert-success">
								...
								<i class=""></i> Sebuah sistem yang digunakan untuk mengidentifikasi masalah belajar siswa. Dibangun menggunakan bahasa pemrograman PHP dan mengimplementasikan Metode <i>Certainty Factor</i>
							</div>
						</div><!-- /.col -->
					</div><!-- /.row -->
					...
					<div class="col-md-3 infobox-container">
						<div class="infobox infobox-green">
							...
							?>
							<div class="infobox-content">Data Bidang Masalah</div>
		            	</div>
						</div>
					</div>
					...
					<div class="col-xs-3 infobox-container" >
						<div class="infobox infobox-red" >
		            	<div class="infobox-icon"><i class="ace-icon fa fa-book"></i></div>
							<?php
								$qsubkategori =" SELECT * FROM t_identifikasi ";
							...
							?> 
		              <div class="infobox-content">Data Aturan</div>
		            	</div>
		          	</div>
					</div>
