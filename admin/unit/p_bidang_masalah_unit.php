        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header detail-ket">
              ...
              <h4 class="modal-title text text-ket"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Detail Untuk <?php echo $r[nama_bidang_masalah]; ?></h4>
            </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header saran-ket">
              <button type="button" class="close" data-dismiss="modal" style="opacity: .99;color: #fff;">&times;</button>
              <h4 class="modal-title text text-ket"><i class="fa fa-quote-right" aria-hidden="true"></i> Saran Untuk <?php echo $r[nama_bidang_masalah]; ?></h4>
            </div>
            <div class="modal-body" style="text-align: justify;text-justify: inter-word;">
