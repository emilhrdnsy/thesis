...
<script type="text/javascript">
	...
	$('#datatable').dataTable({
		"lengthMenu": [
			[10, 25, 50, 100, 500, 1000, -1], [10, 25, 50, 100, 500, 1000, "Semua"]
		]
	});
	...
	function confirm(id_user) {
		swal.fire({
			...
			if (result.value) {
				...
				setTimeout(function () {
					window.location.href = "?unit=bidang_masalah_unit&act=delete&id_bidang_masalah=" +
						id_user
				}, 1200);
			} else {
				Swal.fire({
...
?>
					...
					<form class="form-horizontal" id="tambah_kat" name="tambah_kat" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="col-xs-10 col-sm-5" type="text" name="kode_bidang_masalah" id="kode_bidang_masalah"
									required="required" autofocus="autofocus" value="<?php echo "$newID"; ?>" readonly="" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<textarea class="form-control limited" name="detail_bidang_masalah"
									id="detail_bidang_masalah"> </textarea>
							</div>
						</div>
						<div class="form-group">
...
<?php
	...
	case "inputact":
		...
		$qinput = " INSERT INTO t_bidang_masalah (kode_bidang_masalah, nama_bidang_masalah, detail_bidang_masalah, layanan)
                VALUES ('$kode_bidang_masalah', '$nama_bidang_masalah', '$detail_bidang_masalah', '$layanan') ";
...
<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" id="tambah_kat" name="tambah_kat" method="post"	action="adminmainapp.php?unit=bidang_masalah_unit&act=updateact">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right">Kode Bidang Masalah</label>
							<div class="col-sm-9">
								<input class="col-xs-10 col-sm-5" type="text" name="kode_bidang_masalah" id="kode_bidang_masalah"
									required="required" value="<?php echo $dupdate['kode_bidang_masalah'] ?>" readonly="readonly" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="col-xs-10 col-sm-5" type="text" name="nama_bidang_masalah" id="nama_bidang_masalah"
									required="required" value="<?php echo $dupdate['nama_bidang_masalah'] ?>" autofocus="autofocus" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="detail_bidang_masalah">Detail
								:</label>
							<div class="col-sm-9">
...
<?php
	...
	case "updateact":
		...
		$detail_bidang_masalah = $_POST['detail_bidang_masalah'];
		$layanan = $_POST['layanan'];
		$qupdate = "UPDATE t_bidang_masalah SET nama_bidang_masalah = '$nama_bidang_masalah', detail_bidang_masalah = '$detail_bidang_masalah', layanan = '$layanan'
                WHERE kode_bidang_masalah = '$kode_bidang_masalah' ";
		if($qupdate)
		{
				$rupdate = mysqli_query($mysqli,$qupdate);
